...
public class CustomAtlasSourcesTestInit implements ModInitializer {
	public static final ResourceKey<Item> DOUBLE_IRON_INGOT_KEY = ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("fabric-rendering-v1-testmod", "double_iron_ingot"));
