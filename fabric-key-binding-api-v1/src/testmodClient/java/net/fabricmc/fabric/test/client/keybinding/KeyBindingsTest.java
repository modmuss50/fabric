...
public class KeyBindingsTest implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		KeyMapping.Category category2 = KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath("fabric-key-binding-api-v1-testmod", "test_category_2"));
		KeyMapping.Category category1 = KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath("fabric-key-binding-api-v1-testmod", "test_category_1"));
