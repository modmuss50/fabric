...
abstract class KeyBindsListKeyEntryMixin {
	...
	private boolean fabric_showDefaultChordCollisions(boolean original, @Local KeyMapping otherKey) {
		return original
				&& KeyMappingModifierImpl.getModifierMask(key) == 0
				&& KeyMappingModifierImpl.getModifierMask(otherKey) == 0;
	}
}
