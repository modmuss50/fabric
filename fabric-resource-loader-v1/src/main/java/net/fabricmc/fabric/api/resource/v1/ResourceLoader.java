...
public interface ResourceLoader {
	 ...
	 * @see #addReloaderOrdering(ResourceLocation, ResourceLocation)
	 */
	void registerReloader(ResourceLocation id, PreparableReloadListener reloader);
	 ...
	 * @see #registerReloader(ResourceLocation, PreparableReloadListener) register a new resource reloader
	 */
	void addReloaderOrdering(ResourceLocation firstReloader, ResourceLocation secondReloader);
}
