...
public class ResourceLoaderImplTest {
	...
	public void testReloaderSorting() {
		...
		record Dummy(ResourceLocation id, PreparableReloadListener reloader) {
			Dummy(ResourceLocation id) {
				this(id, new DummyResourceReloader());
			}
		}

		var dummyReloader1 = new Dummy(ResourceLocation.fromNamespaceAndPath("fabric", "dummy_reloader_1"));
		var dummyReloader2 = new Dummy(ResourceLocation.fromNamespaceAndPath("fabric", "dummy_reloader_2"));
		var dummyReloader3 = new Dummy(ResourceLocation.fromNamespaceAndPath("fabric", "dummy_reloader_3"));
		var dummyReloader4 = new Dummy(ResourceLocation.fromNamespaceAndPath("fabric", "dummy_reloader_4"));
		...
		var periodicNotificationManager = new PeriodicNotificationManager(ResourceLocation.parse("a"), o -> true);
