...
public final class ParticleRendererRegistry {
	 ...
	 */
	public static void registerOrdering(ParticleRenderType first, ResourceLocation second) {
	 ...
	 * @param second the texture sheet to render second
	 */
	public static void registerOrdering(ResourceLocation first, ParticleRenderType second) {
	 ...
	 */
	public static @Nullable ParticleRenderType getParticleTextureSheet(ResourceLocation id) {
	 ...
	 */
	public static ResourceLocation getId(ParticleRenderType textureSheet) {
		...
		return ResourceLocation.parse(textureSheet.name());
	}
