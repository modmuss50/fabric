...
public class VanillaBuiltinResourcePackInjectionTestMod implements ModInitializer {
	...
	public static final ResourceKey<Block> KEY = ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(MODID, "testblock"));
	...
	public void onInitialize() {
		...
		Registry.register(BuiltInRegistries.ITEM, KEY.location(), new BlockItem(TEST_BLOCK, new Item.Properties().setId(ResourceKey.create(Registries.ITEM, KEY.location()))));
	}
}
