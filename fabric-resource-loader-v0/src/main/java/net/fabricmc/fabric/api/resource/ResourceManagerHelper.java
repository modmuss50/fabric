...
public interface ResourceManagerHelper {
	 ...
	 * @deprecated Use {@link net.fabricmc.fabric.api.resource.v1.ResourceLoader#RELOADER_REGISTRY_LOOKUP_KEY} with {@link net.minecraft.server.packs.resources.PreparableReloadListener.SharedState} instead.
	 */
	@Deprecated
