...
public class ConventionLogWarnings implements ModInitializer {
	...
	private static final Map<TagKey<?>, TagKey<?>> LEGACY_C_TAGS = Map.<TagKey<?>, TagKey<?>>ofEntries(
			...
			createMapEntry(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("minecraft", "tall_flowers")), net.fabricmc.fabric.api.tag.convention.v2.ConventionalItemTags.TALL_FLOWERS),
			createMapEntry(TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("minecraft", "tall_flowers")), net.fabricmc.fabric.api.tag.convention.v2.ConventionalBlockTags.TALL_FLOWERS)
	);
